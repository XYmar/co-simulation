...
public enum ResultCode {
    ...
    PRODESIGN_LINK_COUNTERSIGN_NOT_FOUND_ERROR(22010,"请指定子任务会签人"),
    ...
    THE_CURRENT_COLLATE_HAS_BEEN_COLLATE(22012,"当前校对人已经会校对过了"),
    THE_CURRENT_AUDIT_HAS_BEEN_AUDIT(22013,"当前审核人已经审核过了"),
    THE_CURRENT_APPORVER_HAS_BEEN_APPORVER(22014,"当前批准人已经批准过了"),
    THE_PROCESS_SUBTASK_HAS_BEEN_REVIEWED(22015,"该流程子任务已经审核或驳回了"),
    THE_PREVIOUS_LAYER_HAS_NOT_BEEN_REVIEWED_OR_REJECTED(22015,"未到达该流程，请查看上一步审核结果"),
    // 子任务文件相关  2300
    ...
    THE_STATE_WAS_NOT_FOUND(23004,"未发现该审核状态"),
    // 文件块相关    3000x
