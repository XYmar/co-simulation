...
public enum ResultCode {
    ...
    PRODESIGN_LINK_CHECK_NOT_FOUND_ERROR(22010, "请指定子任务核对人"),
    PRODESIGN_LINK_APPROVER_NOT_FOUND_ERROR(22010, "请指定子任务批准人"),
    THE_CURRENT_COUNTERSIGNATURE_HAS_BEEN_COUNTERSIGNED(22011, "当前会签人已经会签过了"),
    THE_PROCESS_SUBTASK_HAS_BEEN_REVIEWED(22012, "该流程子任务已经审核或驳回了"),
    THE_PREVIOUS_LAYER_HAS_NOT_BEEN_REVIEWED_OR_REJECTED(22013, "未到达该流程，请查看上一步审核结果"),
    // 子任务文件相关  2300
    ...
    SUBLIBRARY_FILE_AUDITMODE_NOT_FOUND_ERROR(27004,"请选择模式"),
    SUBLIBRARY_FILE_PROOFREADUSERS_NOT_FOUND_ERROR(27005,"请选择校对人"),
    SUBLIBRARY_FILE_AUDITUSERS_NOT_FOUND_ERROR(27006,"请选择审核人"),
    SUBLIBRARY_FILE_COUNTERSIGNUSERS_NOT_FOUND_ERROR(27007,"请选择会签人"),
    SUBLIBRARY_FILE_APPROVEUSERS_NOT_FOUND_ERROR(27008,"请选择批准人"),
    SUBLIBRARY_FILE_STATE_NOT_FOUND_ERROR(27009,"请指明当前审核阶段"),
    SUBLIBRARY_FILE_IFPASS_NOT_FOUND_ERROR(27010,"请传入当前阶段审核结果"),
    SUBLIBRARY_FILE_USER_PASS_DENIED_ERROR(27011,"自己无权限通过"),
    SUBLIBRARY_FILE_USER_ALREADY_COUNTERSIGN_ERROR(27012,"该文件您已处理过"),

    // 子库文件驳回相关2800x
    SUBLIBRARY_FILE_MODIFYWAY_NOT_FOUND_ERROR(28001,"请传入修改方式"),
    SUBLIBRARY_FILE_VERSION_NOT_FOUND_ERROR(28002,"请选择文件更新的版本"),
    SUBLIBRARY_FILE_MODIFY_APPROVE_NOT_PASS_ERROR(28003,"您的二次修改申请还未通过，请耐心等待"),
