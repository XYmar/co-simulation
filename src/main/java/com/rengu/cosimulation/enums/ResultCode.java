...
public enum ResultCode {
    ...
    SUBLIBRARY_FILE_IFPASS_NOT_FOUND_ERROR(270010,"请传入当前阶段审核结果"),
    SUBLIBRARY_FILE_USER_PASS_DENIED_ERROR(270011,"自己无权限通过"),
    SUBLIBRARY_FILE_USER_ALREADY_COUNTERSIGN_ERROR(270012,"该文件您已处理过"),
